.class public Lcom/veriff/sdk/camera/camera2/internal/compat/CameraDeviceCompatBaseImpl;
.super Ljava/lang/Object;
.source "SourceFile"

# interfaces
.implements Lcom/veriff/sdk/camera/camera2/internal/compat/CameraDeviceCompat$CameraDeviceCompatImpl;


# annotations
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/veriff/sdk/camera/camera2/internal/compat/CameraDeviceCompatBaseImpl$CameraDeviceCompatParamsApi21;
    }
.end annotation
...
.method public constructor <init>(Landroid/hardware/camera2/CameraDevice;Ljava/lang/Object;)V
    ...
    iput-object p1, p0, Lcom/veriff/sdk/camera/camera2/internal/compat/CameraDeviceCompatBaseImpl;->mCameraDevice:Landroid/hardware/camera2/CameraDevice;

    .line 45
    iput-object p2, p0, Lcom/veriff/sdk/camera/camera2/internal/compat/CameraDeviceCompatBaseImpl;->mImplParams:Ljava/lang/Object;
...
.method public static checkPhysicalCameraIdValid(Landroid/hardware/camera2/CameraDevice;Ljava/util/List;)V
    ...
    check-cast v0, Lcom/veriff/sdk/camera/camera2/internal/compat/params/OutputConfigurationCompat;

    .line 94
    invoke-virtual {v0}, Lcom/veriff/sdk/camera/camera2/internal/compat/params/OutputConfigurationCompat;->getPhysicalCameraId()Ljava/lang/String;
...
.method public static checkPreconditions(Landroid/hardware/camera2/CameraDevice;Lcom/veriff/sdk/camera/camera2/internal/compat/params/SessionConfigurationCompat;)V
    .locals 1
    ...
    .line 76
    invoke-static {p0, v0}, Lcom/veriff/sdk/camera/camera2/internal/compat/CameraDeviceCompatBaseImpl;->checkPhysicalCameraIdValid(Landroid/hardware/camera2/CameraDevice;Ljava/util/List;)V
...
.method public static create(Landroid/hardware/camera2/CameraDevice;Landroid/os/Handler;)Lcom/veriff/sdk/camera/camera2/internal/compat/CameraDeviceCompatBaseImpl;
    .locals 2

    .line 50
    new-instance v0, Lcom/veriff/sdk/camera/camera2/internal/compat/CameraDeviceCompatBaseImpl;
    ...
    invoke-direct {v0, p0, v1}, Lcom/veriff/sdk/camera/camera2/internal/compat/CameraDeviceCompatBaseImpl;-><init>(Landroid/hardware/camera2/CameraDevice;Ljava/lang/Object;)V
...
.method public static unpackSurfaces(Ljava/util/List;)Ljava/util/List;
    ...
    .line 57
    invoke-virtual {v1}, Lcom/veriff/sdk/camera/camera2/internal/compat/params/OutputConfigurationCompat;->getSurface()Landroid/view/Surface;
...
.method public createCaptureSession(Lcom/veriff/sdk/camera/camera2/internal/compat/params/SessionConfigurationCompat;)V
    ...
    invoke-static {p1}, Lcom/veriff/sdk/camera/camera2/internal/compat/CameraDeviceCompatBaseImpl;->unpackSurfaces(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    .line 132
    iget-object v1, p0, Lcom/veriff/sdk/camera/camera2/internal/compat/CameraDeviceCompatBaseImpl;->mImplParams:Ljava/lang/Object;

    check-cast v1, Lcom/veriff/sdk/camera/camera2/internal/compat/CameraDeviceCompatBaseImpl$CameraDeviceCompatParamsApi21;

    .line 133
    iget-object v2, p0, Lcom/veriff/sdk/camera/camera2/internal/compat/CameraDeviceCompatBaseImpl;->mCameraDevice:Landroid/hardware/camera2/CameraDevice;

    iget-object v1, v1, Lcom/veriff/sdk/camera/camera2/internal/compat/CameraDeviceCompatBaseImpl$CameraDeviceCompatParamsApi21;->mCompatHandler:Landroid/os/Handler;

    invoke-virtual {p0, v2, p1, v0, v1}, Lcom/veriff/sdk/camera/camera2/internal/compat/CameraDeviceCompatBaseImpl;->createBaseCaptureSession(Landroid/hardware/camera2/CameraDevice;Ljava/util/List;Landroid/hardware/camera2/CameraCaptureSession$StateCallback;Landroid/os/Handler;)V
