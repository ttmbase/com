...
# static fields
.field public static final PROTO_BYTE_ARRAY_ENCODING:Ljava/nio/charset/Charset;
...
.field public final legacySettings:Landroid/content/SharedPreferences;
...
# virtual methods
.method public final convertConfigHolder(Lcom/google/firebase/remoteconfig/proto/ConfigPersistence$ConfigHolder;)Ljava/util/Map;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v2}, Lcom/google/firebase/remoteconfig/internal/LegacyConfigsHandler;->convertLegacyAbtExperiments(Ljava/util/List;)Lorg/json/JSONArray;
    ...
    invoke-virtual {p0, v3}, Lcom/google/firebase/remoteconfig/internal/LegacyConfigsHandler;->convertKeyValueList(Ljava/util/List;)Ljava/util/Map;
...
.method public final convertKeyValueList(Ljava/util/List;)Ljava/util/Map;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final convertLegacyAbtExperiment(Ldevelopers/mobile/abt/FirebaseAbt$ExperimentPayload;)Lorg/json/JSONObject;
    .locals 5
...
.method public final convertLegacyAbtExperiments(Ljava/util/List;)Lorg/json/JSONArray;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 272
    invoke-virtual {p0, v1}, Lcom/google/firebase/remoteconfig/internal/LegacyConfigsHandler;->deserializePayload(Lcom/google/protobuf/ByteString;)Ldevelopers/mobile/abt/FirebaseAbt$ExperimentPayload;
    ...
    .line 275
    :try_start_0
    invoke-virtual {p0, v1}, Lcom/google/firebase/remoteconfig/internal/LegacyConfigsHandler;->convertLegacyAbtExperiment(Ldevelopers/mobile/abt/FirebaseAbt$ExperimentPayload;)Lorg/json/JSONObject;
...
.method public final deserializePayload(Lcom/google/protobuf/ByteString;)Ldevelopers/mobile/abt/FirebaseAbt$ExperimentPayload;
    .locals 3
...
.method public final getConvertedLegacyConfigs()Ljava/util/Map;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 196
    invoke-virtual {p0}, Lcom/google/firebase/remoteconfig/internal/LegacyConfigsHandler;->readPersistedConfig()Lcom/google/firebase/remoteconfig/proto/ConfigPersistence$PersistedConfig;
    ...
    invoke-virtual {p0, v2}, Lcom/google/firebase/remoteconfig/internal/LegacyConfigsHandler;->convertConfigHolder(Lcom/google/firebase/remoteconfig/proto/ConfigPersistence$ConfigHolder;)Ljava/util/Map;
    ...
    invoke-virtual {p0, v3}, Lcom/google/firebase/remoteconfig/internal/LegacyConfigsHandler;->convertConfigHolder(Lcom/google/firebase/remoteconfig/proto/ConfigPersistence$ConfigHolder;)Ljava/util/Map;
    ...
    invoke-virtual {p0, v0}, Lcom/google/firebase/remoteconfig/internal/LegacyConfigsHandler;->convertConfigHolder(Lcom/google/firebase/remoteconfig/proto/ConfigPersistence$ConfigHolder;)Ljava/util/Map;
...
.method public final readPersistedConfig()Lcom/google/firebase/remoteconfig/proto/ConfigPersistence$PersistedConfig;
    .locals 7
...
.method public final saveLegacyConfigs(Ljava/util/Map;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public saveLegacyConfigsIfNecessary()Z
    ...
    .line 151
    invoke-virtual {p0}, Lcom/google/firebase/remoteconfig/internal/LegacyConfigsHandler;->getConvertedLegacyConfigs()Ljava/util/Map;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/google/firebase/remoteconfig/internal/LegacyConfigsHandler;->saveLegacyConfigs(Ljava/util/Map;)V
